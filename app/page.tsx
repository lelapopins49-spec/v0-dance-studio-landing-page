  ...
  const salaArmoniaSchedule = [
    {
      ...
      classes: [
        ...
        { time: "17:00", name: "Hip Hop principianti" },
        { time: "18:00", name: "Hip Hop intermedio" },
        { time: "19:15", name: "Recitazione per Adulti" },
      ],
    },
    {
      day: "MARTED\u00cc",
      classes: [
        { time: "16:00", name: "Moderno Intermedio 1" },
        { time: "17:00", name: "Classico Intermedio 1" },
        { time: "18:00", name: "Contemporaneo intermedio 1" },
    ...
    },
    {
      day: "MERCOLED\u00cc",
      classes: [
        { time: "16:00", name: "Danza Aerea intermedio 1" },
        { time: "17:00", name: "Hip Hop Principianti/intermedio" },
        { time: "18:00", name: "Hip Hop avanzato" },
        { time: "19:00", name: "Danza Aerea Avanzato" },
      ],
    },
    {
      day: "GIOVED\u00cc",
    ...
    },
    {
      day: "VENERD\u00cc",
      classes: [
        { time: "16:00", name: "Danza Aerea" },
        { time: "17:00", name: "Repertorio Musical/Recitazione Ragazzi" },
        { time: "18:00", name: "Canto" },
        { time: "19:00", name: "Recitazione per Adulti" },
      ],
    },
  ]
  ...
  const salaRitmoSchedule = [
    {
      day: "LUNEDÌ",
      classes: [
        { time: "9:30", name: "Aerobica/Step/GAG" },
        { time: "16:00", name: "Pilates" },
    ...
    },
    {
      day: "MARTEDÌ",
      classes: [
        { time: "9:30", name: "Danza per adulti" },
        { time: "10:30", name: "Pilates" },
        { time: "16:30", name: "Classico Principianti 1" },
        { time: "17:00", name: "Moderno Principianti 1" },
        { time: "18:00", name: "Moderno intermedio/avanzato" },
        { time: "19:00", name: "Classico intermedio/avanzato" },
      ],
    },
    {
      day: "MERCOLEDÌ",
      classes: [
        { time: "9:30", name: "Aerobica/Step/GAG" },
        { time: "15:00", name: "Aerobica" },
        { time: "16:00", name: "Pilates" },
        { time: "17:00", name: "Predanza" },
        { time: "18:15", name: "Aerobica" },
        { time: "19:00", name: "Workshop maestri esterni" },
      ],
    },
    {
      day: "GIOVEDÌ",
      classes: [
        ...
        { time: "18:00", name: "Moderno intermedio/avanzato" },
        { time: "19:00", name: "Classico Intermedio/avanzato" },
        { time: "20:00", name: "Contemporaneo Avanzato" },
      ],
    },
    {
      day: "VENERDÌ",
